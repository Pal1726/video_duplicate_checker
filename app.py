...
def upload():
    ...
    if video1 and video2:
        ...
        overall_similarity = calculate_overall_similarity(metadata_comparison_result, frame_comparison_result)
...
def calculate_overall_similarity(metadata_result, frame_result):
    # Weights: 20% for metadata, 40% for frame comparison
    metadata_score = 0
    ...
    overall_similarity = (0.2 * metadata_score) + (0.4 * frame_similarity)
